...
export class UiController {
  ...
  private cueBar;
  private message;
  private collisionSubtitle;
  private collisionTitle;
  private collisionIcon;
  private collisionButtons;
  private restartButton;
  private collisionMenuButton;
  ...
  private applyScaleForMode(mode: string) {
    const isCamera = mode === "camera";
